----------------------------------------------------------------------------------------------
-- Leyenda => V: Test correcto ; X: Test fallido ; E: Programa no implementado; S: Semi-mal --
----------------------------------------------------------------------------------------------
...
procedure lab07_pruebas IS
  ...
  procedure yellow IS begin null; end yellow;
  procedure white IS begin null; end white;
  procedure underscore IS begin null; end underscore;
...
BEGIN
  ...
  Fecha_5_R  := ((1,diciembre,2020),(1,febrero,2004),(1,diciembre,2001),(1,febrero,2007),(1,septiembre,2010)); -- Respuesta
  -- Test
